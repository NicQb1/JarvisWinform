...
{
    public class POSTuplePairsX4
    {
        public Session CurrentSession { get; set; }
        public GraphClient client;

        public POSTuplePairsX4(Session crntSession)
        {
            CurrentSession = crntSession;
            client = CurrentSession.client;
        }

        public POSTuplePairsX4BO GetOrCreatePOSTupleParisX4(string pos1, string pos2)
        {
            return client.Cypher
                ...
                .Merge("(w:POSTuplePairsX4 { POST41 = {pos1}, POST42 ={pos2})")
                .Create("w")
                .Return(w => w.As<POSTuplePairsX4BO>())
                .Results
                .Single();
        }
